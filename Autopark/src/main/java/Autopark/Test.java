...
public class Test{
    public static void main(String args[]) throws IncorrectValueException {
        ...
        //cars.getCars();
        //cars.getCarById(1.3);
        //cars.getCarByYear(1989, 1900);
        //cars.getCarByPrice(30000000,200000);
       // cars.deleteCarById(2);
        //cars.getCars();
        cars1.writeVehicleData(v1, "1");
        cars1.writeVehicleData(v2, "1");
        cars1.writeVehicleData(v3, "1");
        cars1.writeVehicleData(v4, "1");
        cars1.writeVehicleData(v5, "1");
